...
namespace App\Filament\Admin\Resources\SimulationRuns\Tables;
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('status')->badge()->color(
                    fn (SimulationRunStatus $state): string => match ($state) {
                        SimulationRunStatus::Pending => 'gray',
                        SimulationRunStatus::Running => 'warning',
                        SimulationRunStatus::Completed => 'success',
                        SimulationRunStatus::Failed => 'danger',
                    },
                ),
